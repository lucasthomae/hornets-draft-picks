...
ggplot() +
  geom_segment(aes(x = -Inf, xend = Inf, y = 0, yend = 0),
               ...
               color = "black") +
  geom_line(data = davis,
            aes(x = SeasonNum, y = WARP, color = "Anthony Davis"),
            size = 1.1) +
  geom_line(data = kidd_gilchrist,
            aes(x = SeasonNum, y = WARP, color = "Michael Kidd-Gilchrist"),
            size = 1.1) +
  scale_x_continuous(breaks = davis$SeasonNum,
                     labels = davis$Season) +
  scale_y_continuous(limits = c(-5, 20),
  ...
  labs(
    ...
    subtitle = "Davis became a much more valuable player than his former college teammate.",
    caption = "Source: basketball-reference.com",
    ylab = "Wins Over Replacement") +
  scale_color_manual(values = c("gold2" = "gold2", "#00788C" = "#00788C"),
                     labels = c("Anthony Davis", "Michael Kidd-Gilchrist")) +
  theme_classic() +
  theme(axis.text.x = element_text(vjust = 0.5),
        plot.title = element_text(face = "bold", size = 18),
        plot.subtitle = element_text(size = 12),
